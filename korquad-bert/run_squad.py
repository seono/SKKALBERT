...
def main():
    ...
    parser.add_argument("--replacement", default="thesaurus", type=str, help="Replacement type e.g.) thesaurus(wordnet), word_emb, contextual_word_emb")
    parser.add_argument("--eda_part", default="question", help="EDA part e.g.) question, context")
    # Other parameters
    parser.add_argument(
        "--data_dir",
        default=None,
